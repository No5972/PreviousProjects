...
<link rel="stylesheet" href="fronthead.css"/>
<link rel="stylesheet" href="news_content.css"/>
<link rel="stylesheet" href="newslist.css"/>
<title>最新消息 - 语音播报门户网站 AudioCMS </title>
</head>
<body>
	<jsp:include page="fronthead.jsp"></jsp:include>
		<div class="h1">
		<div class="h2-left">
				<div class="path"><a href="/AudioCMS">首页</a> &gt; 最新消息</div>
				<div class="list">
				<s:if test="allnews.size()!=0">
					<ul>
						<s:iterator value="allnews" var="news">
							<li>
								<div class="newsitem"><a href="/AudioCMS/news_<s:property value="#news.id"/>.html">
									<s:if test="#news.title.length()>40">
										<s:property value="#news.title.substring(0,40)"/>
									</s:if>
									<s:else><s:property value="#news.title"/></s:else>
								</a></div>
								<div class="newsitem-date"><span><s:date name="#news.createTime" format="yyyy-MM-dd"/></span></div>
							</li>
						</s:iterator>
				...
				<div>
					<div class="pageOperation">
						<a href="/AudioCMS/newest_1.html">首页</a>&nbsp;
						<s:if test="pageNo>1">
						<a href="/AudioCMS/newest_<s:property value="pageNo-1"/>.html">上一页</a>
						</s:if><s:else>
						　　　
						</s:else>
						&nbsp;
						<s:if test="pageNo<pageCount">
						<a href="/AudioCMS/newest_<s:property value="pageNo+1"/>.html">下一页</a>
						</s:if><s:else>
						　　　
						</s:else>
						&nbsp;
						<a href="/AudioCMS/newest_<s:property value="pageCount"/>.html">尾页</a>&nbsp;
					</div>
					<div class="pageNo">
					...
					var setAction = function() {
						document.getElementById("pageswitch").action="/AudioCMS/newest_"+document.getElementById("pageNo").value+".html";
					}
					</script>
					</div>
				</div>
	...
	<div class="h1-down">
		<a href="login.jsp">管理后台登录</a> <a href="#">站长统计</a>
	</div>
</body>
</html>