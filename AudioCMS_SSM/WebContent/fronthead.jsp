...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions"%> 
		...
		<div class="index-logo"><a class="logo-link" href="/AudioCMS_SSM"><img src="/AudioCMS_SSM/static/index_logo.png"/></a></div>
		<div class="welcome"><a class="logo-link" href=""><img src="/AudioCMS_SSM/static/welcome.png"/></a></div>
		<div class="navigator">
		<c:if test="${ fn:length(allCategories)!=0 }">
			<ul class="navigator-list">
				...
				-->
				<li><a class="list-link" href="/AudioCMS_SSM">网站首页</a></li>
				<li><a class="list-link" href="/AudioCMS_SSM/newest_1.html">最新消息</a></li>
				<c:forEach items="${ allCategories }" var="category">
					<c:if test="${ category.id!=2 }">
						<li><a class="list-link" href="/AudioCMS_SSM/category_${ category.id }/newslist_1.html">
							${ category.name }
						</a></li>
					</c:if>
				</c:forEach>
